...
@Component({
  selector: 'app-state-management-age',
  standalone: true,
  templateUrl: './stateManagementPage.component.html',
  styleUrls: ['./stateManagementPage.component.css'],
})
export class StateManagementPageComponent implements OnInit {
